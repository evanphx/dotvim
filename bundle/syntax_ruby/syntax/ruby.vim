...
" not neccessary but useful (so you can use the TAB key to
" fold/unfold):
map <TAB> za
map <S-TAB> zA
map <S-F12> zR
...
syn region rubyString matchgroup=rubyStringDelimit start="%[a-zA-Z]\+!"  end="!"  skip="\\\\\|\\!"  contains=rubyExprSubst
syn region rubyString matchgroup=rubyStringDelimit start="%[a-zA-Z]\+\"" end="\"" skip="\\\\\|\\\"" contains=rubyExprSubst
syn region rubyString matchgroup=rubyStringDelimit start="%[a-zA-Z]\+#"  end="#"  skip="\\\\\|\\#"  contains=rubyExprSubst
syn region rubyString matchgroup=rubyStringDelimit start="%[a-zA-Z]\+\$" end="\$" skip="\\\\\|\\\$" contains=rubyExprSubst
syn region rubyString matchgroup=rubyStringDelimit start="%[a-zA-Z]\+%"  end="%"  skip="\\\\\|\\%"  contains=rubyExprSubst
...
syn region rubyString matchgroup=rubyStringDelimit start="%[a-zA-Z]\+?"  end="?"  skip="\\\\\|\\?"  contains=rubyExprSubst
syn region rubyString matchgroup=rubyStringDelimit start="%[a-zA-Z]\+@"  end="@"  skip="\\\\\|\\@"  contains=rubyExprSubst
syn region rubyString matchgroup=rubyStringDelimit start="%[a-zA-Z]\+\\" end="\\"                   contains=rubyExprSubst
syn region rubyString matchgroup=rubyStringDelimit start="%[a-zA-Z]\+\^" end="\^" skip="\\\\\|\\\^" contains=rubyExprSubst
syn region rubyString matchgroup=rubyStringDelimit start="%[a-zA-Z]\+`"  end="`"  skip="\\\\\|\\`"  contains=rubyExprSubst
syn region rubyString matchgroup=rubyStringDelimit start="%[a-zA-Z]\+|"  end="|"  skip="\\\\\|\\|"  contains=rubyExprSubst
syn region rubyString matchgroup=rubyStringDelimit start="%[a-zA-Z]\+\~" end="\~" skip="\\\\\|\\\~" contains=rubyExprSubst
...
syn keyword rubyBoolean   true false self nil undefined
